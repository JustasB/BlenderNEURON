...
class PhysicsAlignerView(VectorConfinerView):
    ...
    def spring_stiffness(self):
        return self.group.ui_group.layer_confiner_settings.spring_stiffness

    @property
    def spring_damping(self):
        return self.group.ui_group.layer_confiner_settings.spring_damping
    ...
    def add_force_to_layer(self):
        layer = self.group.ui_group.layer_confiner_settings.start_mesh
        field = layer.field
    ...
    def make_containers_rigid_bodies(self):
        ...
        mov_pattern = self.group.ui_group.layer_confiner_settings.moveable_sections_pattern
